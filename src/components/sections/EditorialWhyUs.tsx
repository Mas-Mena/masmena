...
const whyUsData = [
  {
    ...
    icon: (
      <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-14 h-14 text-[var(--text-primary)] opacity-80 transition-all duration-500 group-hover:text-[var(--accent-color)]">
